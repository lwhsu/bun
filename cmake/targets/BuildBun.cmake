...
if(BUN_BOOTSTRAP_GENERATE_CLASSES_NODE OR BUN_BOOTSTRAP_CODEGEN_NODE)
  set(BUN_ZIG_GENERATED_CLASSES_COMMAND
    node
...
if(BUN_BOOTSTRAP_BINDGENV2_NODE STREQUAL "1")
...
elseif(BUN_BOOTSTRAP_BINDGENV2_NODE STREQUAL "0")
  if(BUN_BOOTSTRAP_CODEGEN_NODE)
...
elseif(BUN_BOOTSTRAP_CODEGEN_NODE)
  set(BUN_BINDGENV2_LIST_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
  set(BUN_BINDGENV2_GENERATE_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
endif()
...
if(CMAKE_HOST_SYSTEM_NAME STREQUAL "FreeBSD")
  ...
  if(BUN_BINDGENV2_CPP_OUTPUTS_LEN EQUAL 0)
    message(FATAL_ERROR
      "bindgen-v2 list-outputs produced no .cpp outputs on FreeBSD (BUN_BOOTSTRAP_BINDGENV2_NODE=${BUN_BOOTSTRAP_BINDGENV2_NODE}). "
      "Use -DBUN_BOOTSTRAP_BINDGENV2_NODE=1 to force Node runner for list+generate.")
  endif()
endif()
