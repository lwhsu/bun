...
if(BUN_FREEBSD_GENERATE_CLASSES_NODE OR BUN_FREEBSD_CODEGEN_NODE)
  set(BUN_ZIG_GENERATED_CLASSES_COMMAND
    node
...
set(BUN_BINDGENV2_LIST_COMMAND_PREFIX ${BUN_EXECUTABLE} ${BUN_FLAGS} run ${BUN_BINDGENV2_SCRIPT})
set(BUN_BINDGENV2_GENERATE_COMMAND_PREFIX ${BUN_EXECUTABLE} ${BUN_FLAGS} run ${BUN_BINDGENV2_SCRIPT})
if(BUN_FREEBSD_BINDGENV2_NODE STREQUAL "1")
  set(BUN_BINDGENV2_LIST_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
  set(BUN_BINDGENV2_GENERATE_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
elseif(BUN_FREEBSD_BINDGENV2_NODE STREQUAL "0")
  if(BUN_FREEBSD_CODEGEN_NODE)
    # Historical split mode for investigation: stage0 list-outputs + node generate.
    # On FreeBSD, stage0 list-outputs can be incomplete for bindgen-v2.
    set(BUN_BINDGENV2_GENERATE_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
  endif()
elseif(BUN_FREEBSD_CODEGEN_NODE)
  set(BUN_BINDGENV2_LIST_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
  set(BUN_BINDGENV2_GENERATE_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
endif()

execute_process(
  COMMAND ${BUN_BINDGENV2_LIST_COMMAND_PREFIX}
...
if(CMAKE_HOST_SYSTEM_NAME STREQUAL "FreeBSD")
  list(LENGTH BUN_BINDGENV2_CPP_OUTPUTS BUN_BINDGENV2_CPP_OUTPUTS_LEN)
  if(BUN_BINDGENV2_CPP_OUTPUTS_LEN EQUAL 0)
    message(FATAL_ERROR
      "bindgen-v2 list-outputs produced no .cpp outputs on FreeBSD (BUN_FREEBSD_BINDGENV2_NODE=${BUN_FREEBSD_BINDGENV2_NODE}). "
      "Use -DBUN_FREEBSD_BINDGENV2_NODE=1 to force Node runner for list+generate.")
  endif()
endif()
...
register_command(
  ...
  COMMAND
    ${BUN_BINDGENV2_GENERATE_COMMAND_PREFIX}
      --command=generate
      --codegen-path=${CODEGEN_PATH}
      --sources=${BUN_BINDGENV2_SOURCES_COMMA_SEPARATED}
  SOURCES
