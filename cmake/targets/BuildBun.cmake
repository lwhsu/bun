...
if("$ENV{BUN_FREEBSD_BINDGENV2_NODE}" STREQUAL "1")
...
elseif("$ENV{BUN_FREEBSD_BINDGENV2_NODE}" STREQUAL "0")
  if("$ENV{BUN_FREEBSD_CODEGEN_NODE}" STREQUAL "1")
    # Stage0 can run list-outputs but still fails on generate (file create path).
    # Keep list-outputs on stage0 and use Node runner for generate.
    set(BUN_BINDGENV2_GENERATE_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
  endif()
elseif("$ENV{BUN_FREEBSD_CODEGEN_NODE}" STREQUAL "1")
  set(BUN_BINDGENV2_LIST_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
  set(BUN_BINDGENV2_GENERATE_COMMAND_PREFIX node ${BUN_BINDGENV2_NODE_RUNNER})
endif()
