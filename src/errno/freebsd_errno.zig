...
pub const UV_E = struct {
    ...
    // libuv's FreeBSD headers can expose UV__ENODATA as -9919 (see uv/errno.h)
    // instead of the generic fallback -4024, and Node's getSystemErrorMap() on
    // FreeBSD reports ENODATA at -9919.
    pub const NODATA: i32 = 9919;
