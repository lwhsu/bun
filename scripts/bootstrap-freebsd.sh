...
LEGACY_ZIG_CACHE_ROOT="${BOOTSTRAP_DIR}/legacy-zig-cache"
...
EOF2
  ...
  (
    cd "${LEGACY_WORKTREE}"
    mkdir -p "${LEGACY_ZIG_CACHE_ROOT}/local" "${LEGACY_ZIG_CACHE_ROOT}/global"
    export ZIG_LOCAL_CACHE_DIR="${LEGACY_ZIG_CACHE_ROOT}/local"
    export ZIG_GLOBAL_CACHE_DIR="${LEGACY_ZIG_CACHE_ROOT}/global"
