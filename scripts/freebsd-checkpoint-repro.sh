...
export BUN_FREEBSD_NPM_INSTALL="${BUN_FREEBSD_NPM_INSTALL:-1}"
export BUN_FREEBSD_BINDGENV2_NODE="${BUN_FREEBSD_BINDGENV2_NODE:-1}"
export BUN_FREEBSD_CODEGEN_NODE="${BUN_FREEBSD_CODEGEN_NODE:-1}"
